# cedenar_anomalies guide installation
...
To move beyond notebook prototyping, all reusable code should go into the `cedenar_anomalies/` folder package. To use that package inside your project, install the project's module in editable mode, so you can edit files in the `cedenar_anomalies` folder and use the modules inside your notebooks :
