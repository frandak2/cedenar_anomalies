# cedenar_anomalies/application/load_to_db.py
import argparse
import logging
...
def main():
    ...
    parser.add_argument(
        ...
        default=str(PROCESSED_DATA_DIR / "dataset_limpio_2023.csv"),
    )
    parser.add_argument("--year", type=int, help="Año de los datos", default=2023)
